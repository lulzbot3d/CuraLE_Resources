...
class Formulas(Linter):
    ...
    def getCuraSettingList(self) -> list:
        ...
        with open(os.path.join(os.path.dirname(__file__), "..", "..", "..", "..", "definitions", "fdmprinter.def.json")) as data:
            json_data = json.load(data)
        settings_list += self.extractKeys(json_data)

        with open(os.path.join(os.path.dirname(__file__), "..", "..", "..", "..", "definitions", "fdmextruder.def.json")) as data:
            json_data = json.load(data)
        settings_list += self.extractKeys(json_data)
